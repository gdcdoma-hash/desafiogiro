...
create unique index if not exists inventory_movements_medal_order_receipt_unique
  on public.inventory_movements (inventory_item_id, reference_id)
  where movement_type = 'IN'
    and reason_code = 'MEDAL_ORDER_RECEIPT'
    and reference_type = 'MEDAL_ORDER'
...
begin
  ...
  perform public.reconcile_confirmed_registration_reservations(order_row.challenge_id);
