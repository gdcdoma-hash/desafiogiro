...
alter table public.public_registration_requests
  add column participant_id uuid references public.participants(id) on delete restrict,
  add column registration_id uuid references public.registrations(id) on delete restrict;

create unique index public_registration_requests_registration_uidx
  on public.public_registration_requests(registration_id)
